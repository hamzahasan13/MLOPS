...
with DAG(
    ...
    def data_transformation(**kwargs):
        ...
        train_arr, test_arr, _, input_feature_train_df, input_feature_test_df = tp_obj.initiate_data_transformation(data_ingestion_artifact['train_data_path'], data_ingestion_artifact['test_data_path'])
